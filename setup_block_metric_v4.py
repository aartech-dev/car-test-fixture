...
FIT_CLEARANCE = 0.1                # per side, tongue-to-opening
...
# ---------------- Export ----------------
cq.exporters.export(lid, "/home/claude/AART_setup_block_lid_metric_v4.step")
cq.exporters.export(box, "/home/claude/AART_setup_block_box_metric_v4.step")
